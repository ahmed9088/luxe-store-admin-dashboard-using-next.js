    ...
    return (
        <Dialog {...props}>
            <DialogContent className="overflow-hidden p-0 shadow-lg">
                ...
                <Command className="[&_[data-slot=command-input-wrapper]_svg]:size-5 [&_[data-slot=command-input]]:h-12 [&_[data-slot=command-item]]:px-3 [&_[data-slot=command-item]]:py-3 [&_[data-slot=command-group-label]]:px-3 [&_[data-slot=command-group-label]]:font-medium [&_[data-slot=command-group]]:px-2">
                    {children}
                </Command>
            </DialogContent>
        </Dialog>
